...
<img src="https://github.com/Mohamed-Ashraf-Data/Mohamed-Ashraf-Data/blob/main/images/hello-data.gif" alt="Hello Analyst" width="60%"/> <br>
<img src="https://github.com/Mohamed-Ashraf-Data/Mohamed-Ashraf-Data/blob/main/images/working-analytics.gif" alt="Workspace"  width="40%"/><br> 

</div>

<h2 align="center">👋 Hey there, I'm <strong>Mohamed Ashraf</strong></h2>

<p align="center">
🎯 <strong>Data & Business Analyst</strong> from Egypt<br>
📊 Turning raw data into actionable insights<br>
💡 Passionate about Data Analysis, Visualization, and Business Strategy
</p>
...
- 📈 I analyze data to help businesses make smarter decisions  
- 💻 I work with tools like **Excel, SQL, Power BI, and Python**  
- 🧩 Interested in **Business Intelligence, Data Visualization, and Analytics Engineering**  
- 🌍 Currently learning **Advanced SQL & Power BI automation**  
- ⚽ Fun fact: I love football and data about sports performance!  
...
class MohamedAshraf:
    def __init__(self):
        self.role = "Data & Business Analyst"
        self.skills = ["Excel", "SQL", "Python", "Power BI", "Data Visualization"]
        self.learning = ["Advanced SQL", "Automation", "Data Storytelling"]
